...
import configparser
#filename = 'D:\\my_project\\python3\\django_project\\ToraOps_project\\ToraOps\\common\\config\\vpn_config.cfg'
filename='./config/vpn_config.cfg'
cf = configparser.ConfigParser()
cf.read(filename,encoding='utf-8')
print(cf.sections())
print(cf.get("url_param","add_User_Cloud"))
print(cf.get("parent_group","shnq"))