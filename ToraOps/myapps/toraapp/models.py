...
class ShelfMachine(models.Model): 
    ...
    node = models.ForeignKey('NodeInfo', verbose_name='节点编号', related_name='machine_node', on_delete=models.CASCADE)
...
class NodeInfo(models.Model):
    ...
    engine_room = models.CharField(verbose_name='机房', max_length=10, choices=ROOM_CHOICES)
    #mq = models.ManyToManyField('ToraMq', verbose_name='对应行情', related_name='node_mq')
...
class NodeComponentInfo(models.Model):
...
class TradeNode(models.Model):
    ...
    intnet_addr = models.CharField(verbose_name='互联网地址', max_length=100, blank=True, null=True)
    intnet_port = models.CharField(verbose_name='互联网端口', max_length=20, blank=True, null=True)
...
class VpnUserInfo(models.Model):
    ...
    vpn_phone = models.CharField(verbose_name='vpn注册手机号', max_length=40)
