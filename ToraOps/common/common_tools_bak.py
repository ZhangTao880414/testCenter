...
'''
def send_sms_control(sms_type, msg, phone='13162583883,13681919346,13816703919,18917952875,17512562551'):
...
#            single_times = 999
    ...
    if single_times != 999 and total_used_count < total_count and single_times < single_limit:
        ...
        logger.info("已超过当天可发送的短信总数：%d 条" % total_count)
